...
public class DwFluid2D{
  ...
  public boolean resize(int viewport_width, int viewport_height, int fluidgrid_scale) {
    ...
    resized |= tex_velocity   .resize(context, GLES3Impl.GL_RG16F  , fluid_w, fluid_h, GLES3Impl.GL_RG  , GLES3Impl.GL_FLOAT        , GLES3Impl.GL_LINEAR , 2,4);
    resized |= tex_density    .resize(context, GLES3Impl.GL_RGBA16F, fluid_w, fluid_h, GLES3Impl.GL_RGBA, GLES3Impl.GL_FLOAT        , GLES3Impl.GL_LINEAR , 4,4);
    resized |= tex_temperature.resize(context, GLES3Impl.GL_R16F   , fluid_w, fluid_h, GLES3Impl.GL_RED , GLES3Impl.GL_FLOAT        , GLES3Impl.GL_LINEAR , 1,4);
    resized |= tex_curl       .resize(context, GLES3Impl.GL_R16F   , fluid_w, fluid_h, GLES3Impl.GL_RED , GLES3Impl.GL_FLOAT        , GLES3Impl.GL_LINEAR , 1,4);
    resized |= tex_divergence .resize(context, GLES3Impl.GL_R16F   , fluid_w, fluid_h, GLES3Impl.GL_RED , GLES3Impl.GL_FLOAT        , GLES3Impl.GL_LINEAR , 1,4);
    resized |= tex_pressure   .resize(context, GLES3Impl.GL_R16F   , fluid_w, fluid_h, GLES3Impl.GL_RED , GLES3Impl.GL_FLOAT        , GLES3Impl.GL_LINEAR , 1,4);
    resized |= tex_obstacleC  .resize(context, GLES3Impl.GL_R8     , fluid_w, fluid_h, GLES3Impl.GL_RED , GLES3Impl.GL_UNSIGNED_BYTE, GLES3Impl.GL_NEAREST, 1,1);
    resized |= tex_obstacleN  .resize(context, GLES3Impl.GL_RGBA8  , fluid_w, fluid_h, GLES3Impl.GL_RGBA, GLES3Impl.GL_UNSIGNED_BYTE, GLES3Impl.GL_NEAREST, 4,1);
...
//    shader_gradient.uniform1f     ("halfrdx"      , 0.5f / param.gridscale);
  ...
  public void blendMode(){
    ...
    GLES30.glBlendEquationSeparate(GLES3Impl.GL_FUNC_ADD, GLES3Impl.GL_FUNC_ADD);
    GLES30.glBlendFuncSeparate(GLES3Impl.GL_SRC_ALPHA, GLES3Impl.GL_ONE_MINUS_SRC_ALPHA, GLES3Impl.GL_ONE, GLES3Impl.GL_ONE);
  }
