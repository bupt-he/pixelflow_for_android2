...
public class DistanceTransform {
  ...
  public void resize(int w, int h){
    ...
    tex_dtnn.resize(context, GLES3Impl.GL_RG16UI, w, h, GLES3Impl.GL_RG_INTEGER, GLES3Impl.GL_UNSIGNED_SHORT, GLES3Impl.GL_NEAREST, GLES3Impl.GL_CLAMP_TO_EDGE, 2, 2);
  ...
  public void computeDistanceField(){
    ...
    tex_dist.resize(context, GLES3Impl.GL_R32F, w, h, GLES3Impl.GL_RED, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_CLAMP_TO_EDGE, 1, 4);
