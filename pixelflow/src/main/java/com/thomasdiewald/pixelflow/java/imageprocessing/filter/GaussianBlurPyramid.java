...
//    resize(src.width, src.height, GLES3Impl.GL_RGBA8, GLES3Impl.GL_RGBA, GLES3.GL_UNSIGNED_BYTE, 4, 1);
    resize(src.width, src.height, GLES3Impl.GL_RGBA16F, GLES3Impl.GL_RGBA, GLES3Impl.GL_FLOAT, 4, 2);
  }
...
//    int iformat = GLES3Impl.GL_RGBA32F;
//    switch(src.num_channel){
//      case 1: iformat = GLES3Impl.GL_R16F   ; break;
//      case 2: iformat = GLES3Impl.GL_RG16F  ; break;
//      case 3: iformat = GLES3Impl.GL_RGB16F ; break;
//      case 4: iformat = GLES3Impl.GL_RGBA16F; break;
//    }
//    resize(src.w, src.h, iformat, src.format, GLES3Impl.GL_FLOAT, src.num_channel, 2);
  }
...
//      hi = (int) Math.ceil(hi * 0.5f);
      tex_temp[i].resize(context, internal_format, wi, hi, format, type, GLES3Impl.GL_LINEAR, GLES3Impl.GL_CLAMP_TO_EDGE, num_channels, bbp);
      tex_blur[i].resize(context, internal_format, wi, hi, format, type, GLES3Impl.GL_LINEAR, GLES3Impl.GL_CLAMP_TO_EDGE, num_channels, bbp);
      wi = (int) Math.ceil(wi * 0.5f);
      hi = (int) Math.ceil(hi * 0.5f);
    }
  }
