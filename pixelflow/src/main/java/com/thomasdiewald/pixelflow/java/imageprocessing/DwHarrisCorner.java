...
public class DwHarrisCorner {
    ...
    public static class Frame {
        ...
        public boolean resize(DwPixelFlow context_, int w, int h) {
            ...
            resized |= frame.resize(context, GLES3Impl.GL_R16F, w, h, GLES3Impl.GL_RED, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, 1, 4);
            resized |= sobelH.resize(context, GLES3Impl.GL_R16F, w, h, GLES3Impl.GL_RED, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, 1, 4);
            resized |= sobelV.resize(context, GLES3Impl.GL_R16F, w, h, GLES3Impl.GL_RED, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, 1, 4);
            resized |= harrisMatrix.resize(context, GLES3Impl.GL_RGB16F, w, h, GLES3Impl.GL_RGB, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, 3, 4);
            resized |= harrisCorner.resize(context, GLES3Impl.GL_R16F, w, h, GLES3Impl.GL_RED, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, 1, 4);
            resized |= tmp.resize(context, GLES3Impl.GL_RGBA16F, w, h, GLES3Impl.GL_RGBA, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, 4, 4);
            context.end();
            return resized;
        }
