...
public class DwLiquidFX {
  ...
  protected final int SWIZZLE_R = GLES3Impl.GL_RED;
  protected final int SWIZZLE_G = GLES3Impl.GL_GREEN;
  protected final int SWIZZLE_B = GLES3Impl.GL_BLUE;
  protected final int SWIZZLE_A = GLES3Impl.GL_ALPHA;
  protected final int SWIZZLE_0 = GLES3Impl.GL_ZERO;
  protected final int SWIZZLE_1 = GLES3Impl.GL_ONE;
  ...
  public void apply(PGraphicsOpenGL pg_src, PGraphicsOpenGL pg_dst){
    int w = pg_src.width;
    int h = pg_src.height;
//    tex_particles.resize(context, GLES3Impl.GL_RGBA8, w, h, GLES3Impl.GL_RGBA, GLES3Impl.GL_UNSIGNED_BYTE, GLES3Impl.GL_LINEAR, 4, 1);
    tex_particles.resize(context, GLES3Impl.GL_RGBA16F, w, h, GLES3Impl.GL_RGBA, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, 4, 2);
//    for(int i = 0; i < 50; i++){
