...
//  protected int tex_target = GLES3Impl.GL_TEXTURE_2D;
//  protected void setLinearTextureFiltering(int handle_tex){
//    context.begin();
//   GLES3Impl.glBindTexture(tex_target, handle_tex);
//   GLES3Impl.glGetTexParameteriv(tex_target, GLES3Impl.GL_TEXTURE_MIN_FILTER, filter_minmag, 0);
//   GLES3Impl.glGetTexParameteriv(tex_target, GLES3Impl.GL_TEXTURE_MAG_FILTER, filter_minmag, 1);
//   GLES3Impl.glTexParameteri    (tex_target, GLES3Impl.GL_TEXTURE_MIN_FILTER, GLES3Impl.GL_LINEAR);
//   GLES3Impl.glTexParameteri    (tex_target, GLES3Impl.GL_TEXTURE_MAG_FILTER, GLES3Impl.GL_LINEAR);
//   GLES3Impl.glBindTexture      (tex_target, 0);
//    context.end();
//  }
//
...
//    context.begin();
//   GLES3Impl.glBindTexture      (tex_target, handle_tex);
//   GLES3Impl.glTexParameteri    (tex_target, GLES3Impl.GL_TEXTURE_MIN_FILTER, filter_minmag[0]);
//   GLES3Impl.glTexParameteri    (tex_target, GLES3Impl.GL_TEXTURE_MAG_FILTER, filter_minmag[1]);
//   GLES3Impl.glBindTexture      (tex_target, 0);
//    context.end();
//  }
//
