...
public class SummedAreaTable{
  ...
  static public enum InternalFormat{
    R32F    (GLES3Impl.GL_R32F   , GLES3Impl.GL_RED , 1),
    RG32F   (GLES3Impl.GL_RG32F  , GLES3Impl.GL_RG  , 2),
    RGB32F  (GLES3Impl.GL_RGB32F , GLES3Impl.GL_RGB , 3),
    RGBA32F (GLES3Impl.GL_RGBA32F, GLES3Impl.GL_RGBA, 4);
  ...
  public void resize(int w, int h){
    sat_src.resize(context, format.gl_internalformat, w, h, format.gl_format, GLES3Impl.GL_FLOAT, GLES3Impl.GL_NEAREST, format.num_channels, 4);
    sat_dst.resize(context, format.gl_internalformat, w, h, format.gl_format, GLES3Impl.GL_FLOAT, GLES3Impl.GL_NEAREST, format.num_channels, 4);
  }
