...
//  }
  ...
  public void resize(int num_lines_x_, int num_lines_y_){
    ...
    // allocate texture
    tex_vertices.resize(context, GLES3Impl.GL_RG32F, lines_x, lines_y, GLES3Impl.GL_RG, GLES3Impl.GL_FLOAT, GLES3Impl.GL_NEAREST, 2, 4);
...
//      float space_y    = h / (float) lines_y;
    ...
    for(int segment_idx = 0; segment_idx < param.line_length; segment_idx++){
      ...
      GLES30.glBlendFunc(GLES3Impl.GL_SRC_ALPHA, GLES3Impl.GL_ONE_MINUS_SRC_ALPHA); // BLEND
      GLES30.glBlendFunc(GLES3Impl.GL_SRC_ALPHA, GLES3Impl.GL_ONE);                 // ADD
