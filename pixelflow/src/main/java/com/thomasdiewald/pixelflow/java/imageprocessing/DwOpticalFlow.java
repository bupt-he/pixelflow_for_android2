...
public class DwOpticalFlow {
  ...
  public static class Frame{
    ...
    public boolean resize(DwPixelFlow context_, int w, int h, boolean grayscale){
      int internalformat = grayscale ? GLES3Impl.GL_R16F : GLES3Impl.GL_RGBA16F;
      int format         = grayscale ? GLES3Impl.GL_RED  : GLES3Impl.GL_RGBA;
      ...
      context.begin();
      boolean resized = false;
      resized |= frame   .resize(context, internalformat, w, h, format     , GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, channels, 2);
      resized |= sobelH  .resize(context, internalformat, w, h, format     , GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, channels, 2);
      resized |= sobelV  .resize(context, internalformat, w, h, format     , GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, channels, 2);
      resized |= velocity.resize(context, GLES3Impl.GL_RG16F  , w, h, GLES3Impl.GL_RG  , GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, 2       , 2);
      resized |= tmp     .resize(context, GLES3Impl.GL_RGBA16F, w, h, GLES3Impl.GL_RGBA, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_MIRRORED_REPEAT, 4       , 2);
      context.end();
      return resized;
    }
