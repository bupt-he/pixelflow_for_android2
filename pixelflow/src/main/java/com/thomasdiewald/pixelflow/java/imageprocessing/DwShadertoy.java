...
public class DwShadertoy{
  ...
  public boolean resize(int w, int h){
    boolean resized = tex.resize(context, GLES3Impl.GL_RGBA32F, w, h, GLES3Impl.GL_RGBA, GLES3Impl.GL_FLOAT, GLES3Impl.GL_LINEAR, GLES3Impl.GL_CLAMP_TO_EDGE, 4, 4);
...
//    }
  ...
  static public enum TexFilter{
    NEAREST(GLES3Impl.GL_NEAREST, GLES3Impl.GL_NEAREST),
    LINEAR(GLES3Impl.GL_LINEAR, GLES3Impl.GL_LINEAR),
    MIPMAP(GLES3Impl.GL_LINEAR_MIPMAP_LINEAR, GLES3Impl.GL_LINEAR);
  ...
  static public enum TexWrap{
    CLAMP(GLES3Impl.GL_CLAMP_TO_EDGE),
    REPEAT(GLES3Impl.GL_MIRRORED_REPEAT);
